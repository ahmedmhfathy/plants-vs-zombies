...
//using namespace sf;
//
//enum State {MainMenu, Level1, Level2, Level3};
//
...
//    }
//    for (int i = 0; i < 4; i++) {
//        if (PlantsArray[i].shape.getGlobalBounds().intersects(box.getGlobalBounds()))
//        {
//            PlantsArray[i].takeDmg(.5);
//        }
//    }    
//}
//void DrawLevel1(RenderWindow& window)
//{
//    DrawPlantsAndProjectiles(window);
//    window.draw(box);
//}
//
//void StartLevel2()
