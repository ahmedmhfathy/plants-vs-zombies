...
#pragma endregion
    ...
    void loadphoto() {
        ...
        Textstartwave2sprite.setPosition(1280 / 1.8f, 720 / 1.8f);
        //=================================**load Final Wave**=====================================
        ...
        Textstartfinalwavesprite.setPosition(1280 / 1.8f, 720 / 1.8f);
        // ==============================**load lose Game**========================================
        ...
        Textlosegamesprite.setPosition(1280 / 2.f, 720 / 1.8f);
    }
    ...
    void movecamera(RenderWindow& window) {
        ...
        if (!moveright) {
            if (GardenCamera.getCenter().x <= 1040) {
                ...
                GardenCamera.setCenter(easeInOut(CubicEaseInOut, startValue, endValue, animcameraClock, seconds(3)), 400);
            }
            else {
                moveright = true;
            }
        ...
        if (!moveleft && moveright) {
            if (GardenCamera.getCenter().x > 645) {
                ...
                GardenCamera.setCenter(easeInOut(CubicEaseInOut, startValue, endValue, animcameraClock, seconds(4)), 400);
            }
            else {
                moveleft = true;
            }
